...
SECRET_KEY = 'django-insecure-1#mih4%)_1xlop2^&i75uc-vuyrgfb^g2^rdm(00j7n*apdb6%'
...
MIDDLEWARE = [
    ...
    'store.middleware.LoginRequiredMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store.context_processors.fav_item_count',
            ],
        },
    },
]
